        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="fullname" id="fullname" class="form-control mt-2" placeholder="𝙽𝚘𝙲𝚊𝚜𝚑_𝚡𝙳" aria-describedby="help-fullname" value="<?= old('fullname') ?: ($user->fullname ?: '') ?>">
                    <?php if ($validation->hasError('fullname')) : ?>
                        <small id="help-fullname" class="text-danger"><?= $validation->getError('fullname') ?></small>
                    <?php endif; ?>
                </div>
                <div class="form-group my-2">
                    <button type="submit" class="card-header p3"style="background-image: url('https://i.postimg.cc/3rLBGs9m/images-3.jpg')">Update Account</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
