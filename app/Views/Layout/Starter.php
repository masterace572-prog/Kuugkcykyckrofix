...
window.location = (host.concat('/public/register'));
      }
      function login(){
var host = window.location.protocol + "//" + window.location.host;
window.location = (host.concat('/public/login'));
      }
</script>
...
<body>
    ...
    <!-- End of menu -->
    <main>
                  <div class="card shadow-lg p-0 mb-5 -light" style="background-image: linear-gradient(rgb(255, 255, 255) , #FFFFFF); style="max-width: 80rem;">
            <!-- Start content -->
     ...
     <footer class="fixed-bottom bg-body border-top py-3 text-muted">
        <div class="container">        
            <small class="text-muted">&copy 2023 - 2024</small>
        </div>
    </footer>
