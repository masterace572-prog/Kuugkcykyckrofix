...
<div class="row pb-5 justify-content-center">
    ...
    <div class="col-lg-8 mb-1">
        <div class="card">
               <div class=" shadow-lg p-3 mb-1 text-white" role="alert" style="background: linear-gradient(0.9turn, #1B1B1B, #1B1B1B, #1B1B1B);">
                <div class="row">
                    <div class="col pt-1">
                        Key Information
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="registrator" class="form-label">Registeror</label>
                    ...
                    <div class="col-lg-12 mb-3">
                        <label for="devices" class="form-label">Devices<span class="bg-dark text-white px-1 rounded maxDev"><?= $key_info->total ?>/<?= $key->max_devices ?></span> <small class="text-muted">[Seperately With Enter]</small></label>
