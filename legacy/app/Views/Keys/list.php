                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start" aria-labelledby="navbarDropdown">
                                 <div class="card-header bg-light text-black h6 p-3">
                                    ...
                                    <li>
                                        ...
                                        <li>
                                        <a class="dropdown-item" href="<?= site_url('keys/unused_delete')  ?>">
                                            <i class="bi bi-bootstrap-reboot"></i> &nbsp;<button class="btn btn-secondary">Delete Unused Keys</button>
                                        </a>
            ...
            columns: [{
            ...
            
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var btnExted = `<button class="btn btn-outline-danger btn-sm" onclick="keyTime('${row.user_key}')"
                        data-bs-toggle="tooltip" data-bs-placement="left" title="Exted Key?"><i class="bi bi-toggle-on"></i></button>`;
    ...
    function keyTime(keys) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var base_url = window.location.origin;
                var api_url = `${base_url}/keys/keyTime`;
                $.getJSON(api_url, {
                        userkey: keys,
                        delete: 1
                    },
