...
<div class="card">
  ...
  <div class="ds-skill">
    <h6>Total Number Of Keys Made:-  <i class="fa fa-code" aria-hidden="true" style="color:#08f26e;"><?php echo $userDetails2." Keys"; ?></p>
...
<button class="button-85" onclick="buta()" style="margin-top:20px;">Dashboard</button>
    ...
    <h6>Total Number Of Keys Made Till Now <i class="fa fa-code" aria-hidden="true"> style="color:#08f26e;"><?php echo $userDetails2." Keys"; ?></i></h6>
    <div class="skill html"hidden>
      <h6><i class="fab fa-html5"></i> <?php echo "PUBG :-".$userDetails2." Keys"; ?> </h6>
      <div class="bar bar-html" hidden>
        <p><?php echo $userDetails2." keys"; ?></i></h6>
      </div>
    </div>
